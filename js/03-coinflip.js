...
if (flip === "heads" && choice === "heads") {
    message = "The flip was heads and you chose heads...you win!";
}
else if (flip === "heads" && choice === "tails") {
    message = "The flip was heads but you chose tails...you lose!";
}
else if (flip === "tails" && choice === "heads") {
    message = "The flip was tails but you chose heads...you lose!";
}
else if (flip === "tails" && choice === "tails") {
    message = "The flip was tails and you chose tails...you win!";
}
else {
    message = "Invalid choice. Please choose either Heads or Tails.";
}
alert(message);